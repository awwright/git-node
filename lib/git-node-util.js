...
Git.prototype.getCompatibleVersions = function getCompatibleVersions(versionRange, callback){
	this.getVersions(function(err, versiontags){
		if(err) throw err;
		var versions = Object.keys(versiontags).filter(function(v){return semver.satisfies(v, versionRange)});
